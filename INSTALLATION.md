...
- Install Zotify with: `pipx install git+https://github.com/MihaiStreames/zotify.git`
...
- Install Zotify: `pipx install git+https://github.com/MihaiStreames/zotify.git`
- Done! Use `zotify --help` for a basic list of commands or check the README.md file in Zotify's code repository for full documentation.
