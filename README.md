...
`pipx install git+https://github.com/MihaiStreames/zotify.git`
...
`python -m pip install git+https://github.com/MihaiStreames/zotify.git`
...
**If Executable (pipx):**
`pipx install -f git+https://github.com/MihaiStreames/zotify.git`

**If Module:**
`python -m pip install --force-reinstall git+https://github.com/MihaiStreames/zotify.git`
